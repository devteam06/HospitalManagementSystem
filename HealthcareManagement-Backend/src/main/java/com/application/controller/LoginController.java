...
import com.application.service.AdminRegistrationService;
...
public class LoginController 
{
    ...
    {
    	return "Back end applicaiton is up and running!!!";
    }
	...
	{
		System.out.println("USERRRRRRRR LOGIN CALLED");
	...
	{
		System.out.println("ADMINNNNNNNNN  called");
		...
		if(currEmail != null && currPassword != null)
		{
			adminObj = adminRegistrationService.fetchAdminByEmailAndPassword(currEmail, currPassword);
		}
		if(adminObj == null)
		{
			throw new Exception("User does not exists!!! Please enter valid credentials...");
