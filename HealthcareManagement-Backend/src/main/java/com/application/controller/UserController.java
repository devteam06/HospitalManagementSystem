...
public class UserController 
{
	...
	public ResponseEntity<Appointments> addNewAppointment(@RequestBody Appointments appointment) throws Exception
	{
		...
		mailmessage.setText("Dear " + appointment.getPatientname() + "," + " \n"
				+ "Thannk your for choosing us, We here by confirm that you have made an appointment with the Doctor "+appointment.getDoctorname()+" for the reason below "
				+appointment.getProblem()+" We would like you to inform theat pleae here before 10 Min to the Appointment Date "+appointment.getDate()+"and the slot of the appointment is "+appointment.getSlot()+"\nThank you"+"\nEMR Tech");
		mailmessage.setSubject("EMR-Appointment Confirmation");
